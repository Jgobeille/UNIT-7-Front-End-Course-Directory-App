...
class Home extends Component {
  ...
  handleSubmit(e) {
    e.preventDefault();
    // teacher name and topics input values can now be accessed
    let teacherName = this.name.value;
    let teacherTopic = this.topic.value;
    //generated URL path that takes the input teachers topic and name
    let path = `teachers/${teacherTopic}/${teacherName}`;
    //this pushs the generated URL and pushes it to the the history prop of the home component
    ...
    return (
      <div className="main-content home">
        ...
        <form onSubmit={this.handleSubmit}>
          {/* Refs let you get "access/reference" to a DOM element */}
          {/* The refs are invoked on page load and allow the input data to be accessed 
              at any time
          */}
          <input
            type="text"
